...
def performance_analysis(dim_reduction="Isomap", neighbor_percentage=0.1, iterations=3, kernel="RBF", variance_threshold=3.0, independence_threshold=0.05, regression_method="GPR", independence_method="HSIC", min_distance="Nelder-Mead", min_projection="Nelder-Mead", dataset=0, filename):
    times = []
